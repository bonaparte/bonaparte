...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(80).register();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bp = __webpack_require__(82);

	///////////////////////////////////////////////////////////////////////////////
	// Public

	module.exports = bp.tag.create("toolbar", __webpack_require__(92), {
	  0 : {
	    role :"toolbar",
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(typeof document.addEventListener === "function") { // no polyfills for IE8 -> silently fail.
	  ...
	  if(!("MutationObserver" in document)) {
	    MutationObserver = __webpack_require__(89);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objct = __webpack_require__(84);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function createTag(name, modules, children, nativeBaseElement){
	  ...
	  var childrenModule = __webpack_require__(86)(name, children);

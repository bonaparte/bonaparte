...
/***/ function(module, exports, __webpack_require__) {
	...
	if(typeof document.addEventListener === "function") { // no polyfills for IE8 -> silently fail.
	  ...
	  if(!("MutationObserver" in document)) {
	    MutationObserver = __webpack_require__(13);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objct = __webpack_require__(8);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(typeof document.addEventListener === "function") { // no polyfills for IE8 -> silently fail.
	  ...
	  if(!("MutationObserver" in document)) {
	    MutationObserver = __webpack_require__(24);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objct = __webpack_require__(20);
	// var easing = require("./easing");
...
/***/ function(module, exports, __webpack_require__) {
	...
	///////////////////////////////////////////////////////////////////////////////
	  ...
	  function setTargets(){
	    ...
	    var potentialToolbar = bp.tag.closest(tag, "bonaparte-toolbar");
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(typeof document.addEventListener === "function") { // no polyfills for IE8 -> silently fail.
	  ...
	  if(!("MutationObserver" in document)) {
	    MutationObserver = __webpack_require__(35);
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objct = __webpack_require__(31);
	// var easing = require("./easing");
